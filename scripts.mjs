...
function getMdTableStr(dt = [], isSub = false) {
  ...
  dt.forEach(item => {
    ...
    const npmVersion = item.npm ? `[![npm version](https://img.shields.io/npm/v/${item.npm}.svg?label=&logo=npm&style=flat&labelColor=4f4f4f)](https://www.npmjs.com/package/${item.npm})` : '';
